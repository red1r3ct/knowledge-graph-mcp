...
import (
	...
	knowledgebase "github.com/red1r3ct/knowledge-graph-mcp/internal/knowledgebase"
)
...
func (m *MockStorage) Create(ctx context.Context, req knowledgebase.CreateRequest) (*knowledgebase.KnowledgeBase, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", ctx, req)
	ret0, _ := ret[0].(*knowledgebase.KnowledgeBase)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStorage) Get(ctx context.Context, id int64) (*knowledgebase.KnowledgeBase, error) {
	m.ctrl.T.Helper()
...
func (m *MockStorage) List(ctx context.Context, req knowledgebase.ListRequest) (*knowledgebase.ListResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List", ctx, req)
	ret0, _ := ret[0].(*knowledgebase.ListResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStorage) Update(ctx context.Context, id int64, req knowledgebase.UpdateRequest) (*knowledgebase.KnowledgeBase, error) {
	m.ctrl.T.Helper()
